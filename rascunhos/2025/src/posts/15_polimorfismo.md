...
rectangle Memoria{
    ...
    salario: 1000.0
    senha: 1234
    numeroDeFuncionariosGerenciados: 10
    ----
    ]
...
IO.println(controle.getTotalDeBonificacoes());
```
